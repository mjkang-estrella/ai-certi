...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1774271422710-8fy370 | 2026-03-23T13:10:26.297Z

**Codebase Map:**
  src/: App, main, vite-env.d
  src/components/: ActionQueueCard, AppShell, CompanyDetailPanel, CompanyList, DashboardBanner, ErrorBoundary, ExaminerStatusSection, InfoListCard, MobileNav, ProjectsTable
  src/data/: dashboard
  src/pages/: CompaniesPage, DashboardPage
  (root): vite.config
